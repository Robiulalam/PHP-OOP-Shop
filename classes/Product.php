...
class Product{
	...
	public function ProductInsert($data, $file){
	    ...
	    if ($productName == "" || $catId == "" || $brandId == "" || $body == "" || $price == "" || $file_name == "" || $type == "" ) {
			...
			if ($productinsert) {
				$msg = " <span class='success'>product Insarted Sucessfully</span> ";
				return $msg;
			}else{
				$msg = " <span class='error'>product Not Insarted </span> ";
				return $msg;
			}
	    }
	}
	...
	public function ProductUpdate($data, $file,  $id){
		...
		public function getFeaturedProductBrand(){
