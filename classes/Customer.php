		...
		$pass = mysqli_real_escape_string($this->db->link, md5($data['pass']));
		 ...
		 if ($name == "" || $address == "" || $city == "" || $country == "" || $zip == "" || $phone == "" || $email == "" || $pass == "") {
		   ...
		   if ($mailchk != false) {
			...
			if ($inserted_row) {
				$msg = " <span class='success'>Customer Data Insarted Sucessfully.</span> ";
				return $msg;
			}else{
				$msg = " <span class='error'>Customer Data Not Insarted ! </span> ";
				return $msg;
			}
		   }
		...
		$email = mysqli_real_escape_string($this->db->link, $data['email']);
		 ...
		 if ($name == "" || $address == "" || $city == "" || $country == "" || $zip == "" || $phone == "" || $email == "") {
			...
			return $msg;
				...
				if ($updated_row) {
					$msg = " <span class='success'>Customer Data Update Sucessfully</span> ";
				return $msg;
				}else{
